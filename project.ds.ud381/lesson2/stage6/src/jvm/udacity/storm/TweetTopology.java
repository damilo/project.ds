...
import udacity.storm.tools.RollingCountBolt;
...
public class TweetTopology {
  ...
  public static void main(String[] args) throws Exception
  {
    ...
    builder.setBolt ("count-bolt", new RollingCountBolt (30, 10), 15).fieldsGrouping ("parse-tweet-bolt", new Fields ("tweet-word"));
    ...
    String topologyName = "tweet-word-rolling-count";
