...
class TweetTopology
{
  public static void main(String[] args) throws Exception
  {
    ...
    builder.setBolt ("url-bolt", new UrlBolt (), 10).shuffleGrouping ("tweet-spout");
    ...
    builder.setBolt ("parse-tweet-bolt", new ParseTweetBolt (), 10).shuffleGrouping ("url-bolt");

    //************* replace Java "parse-tweet-bolt" with Java/Python "python-split-sentence"
    builder.setBolt ("count-bolt", new CountBolt (), 15).fieldsGrouping ("parse-tweet-bolt", new Fields ("tweet-url-word"));
