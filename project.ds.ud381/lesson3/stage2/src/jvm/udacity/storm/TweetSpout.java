...
public class TweetSpout extends BaseRichSpout {
  ...
  private class TweetListener implements StatusListener {
    ...
    public void onStatus (Status status) {
      // get array of type URLEntity of tweet
      URLEntity[] urlEntities = status.getURLEntities ();
      // if array not empty...
      if (urlEntities.length > 0) {
        // ...add first URL of type String to queue
        queue.offer (urlEntities[0].getURL ());
      }
    }
  ...
  public void nextTuple() {
    ...
    // buffer is filled by the TweetListener.onStatus callback
  ...
  public void declareOutputFields(OutputFieldsDeclarer outputFieldsDeclarer) {
    ...
    outputFieldsDeclarer.declare (new Fields ("tweet-url"));
  }
}
