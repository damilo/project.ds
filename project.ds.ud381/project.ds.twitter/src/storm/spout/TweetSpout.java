...
/**
 * A spout that uses Twitter streaming API for continuously getting tweets, emits: tweet
 */
public class TweetSpout extends BaseRichSpout {

    public static final String Name = "spout-tweet-receiver";
    ...
    private class TweetListener implements StatusListener {
        ...
        public void onStatus (Status status) {
            queue.offer (status.getText ()); // add the tweet into the queue buffer
        }
